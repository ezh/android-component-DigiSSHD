...
package org.digimead.digi.inetd.sshd.service.options
...
class UI(ctx: org.digimead.digi.inetd.sshd.service.TabActivity) {
...
object UI {
  ...
  class Adapter(ctx: org.digimead.digi.inetd.sshd.service.TabActivity, values: Seq[Item])
